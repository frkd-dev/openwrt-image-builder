...
1. Go to "Actions" tab in your freshly forked repository.
2. Select "Build Image" action in the left panel.
3. Click "Run workflow" button.
4. Fill required fields.
5. Run the workflow.
6. Once action is done running, open the last "Build image" run to view and download artifacts.
